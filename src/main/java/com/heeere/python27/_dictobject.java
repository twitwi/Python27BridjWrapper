...
public class _dictobject extends StructObject {
	...
	@Ptr 
	@Field(0) 
	public _dictobject ob_refcnt(long ob_refcnt) {
	...
	@Ptr 
	@Field(2) 
	public _dictobject ma_fill(long ma_fill) {
		this.io.setSizeTField(this, 2, ma_fill);
		return this;
	}
	/**
	 * # Active<br>
	...
	@Ptr 
	@Field(3) 
	public _dictobject ma_used(long ma_used) {
		this.io.setSizeTField(this, 3, ma_used);
		return this;
	}
	/**
	...
	@Ptr 
	@Field(4) 
	public _dictobject ma_mask(long ma_mask) {
		this.io.setSizeTField(this, 4, ma_mask);
		return this;
	}
	/**
