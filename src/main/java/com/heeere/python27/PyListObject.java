...
public class PyListObject extends StructObject {
	...
	@Ptr 
	@Field(0) 
	public PyListObject ob_refcnt(long ob_refcnt) {
	...
	@Ptr 
	@Field(2) 
	public PyListObject ob_size(long ob_size) {
	...
	@Ptr 
	@Field(4) 
	public PyListObject allocated(long allocated) {
		this.io.setSizeTField(this, 4, allocated);
		return this;
	}
