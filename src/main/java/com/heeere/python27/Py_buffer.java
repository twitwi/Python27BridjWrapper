...
public class Py_buffer extends StructObject {
	...
	/// C type : Py_ssize_t
	@Field(2) 
	public Pointer<Py_ssize_t > len() {
		return this.io.getPointerField(this, 2);
	}
	/// C type : Py_ssize_t
	@Field(2) 
	public Py_buffer len(Pointer<Py_ssize_t > len) {
		this.io.setPointerField(this, 2, len);
		return this;
	}
	/**
	 ...
	 */
	@Field(3) 
	public Pointer<Py_ssize_t > itemsize() {
	 ...
	 */
	@Field(3) 
	public Py_buffer itemsize(Pointer<Py_ssize_t > itemsize) {
		this.io.setPointerField(this, 3, itemsize);
		return this;
	}
	@Field(4) 
	public int readonly() {
	...
	/// C type : Py_ssize_t*
	@Field(7) 
	public Pointer<Py_ssize_t > shape() {
		return this.io.getPointerField(this, 7);
	}
	/// C type : Py_ssize_t*
	@Field(7) 
	public Py_buffer shape(Pointer<Py_ssize_t > shape) {
		this.io.setPointerField(this, 7, shape);
		return this;
	}
	/// C type : Py_ssize_t*
	@Field(8) 
	public Pointer<Py_ssize_t > strides() {
		return this.io.getPointerField(this, 8);
	}
	/// C type : Py_ssize_t*
	@Field(8) 
	public Py_buffer strides(Pointer<Py_ssize_t > strides) {
		this.io.setPointerField(this, 8, strides);
		return this;
	}
	/// C type : Py_ssize_t*
	@Field(9) 
	public Pointer<Py_ssize_t > suboffsets() {
		return this.io.getPointerField(this, 9);
	}
	/// C type : Py_ssize_t*
	@Field(9) 
	public Py_buffer suboffsets(Pointer<Py_ssize_t > suboffsets) {
	...
	@Array({2}) 
	@Field(10) 
	public Pointer<Pointer<Py_ssize_t > > smalltable() {
