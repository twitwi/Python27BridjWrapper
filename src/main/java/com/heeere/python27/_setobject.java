...
public class _setobject extends StructObject {
	...
	/// C type : Py_ssize_t
	@Field(0) 
	public _setobject ob_refcnt(Pointer<Py_ssize_t > ob_refcnt) {
	 ...
	 */
	@Field(2) 
	public Pointer<Py_ssize_t > fill() {
	 ...
	 */
	@Field(2) 
	public _setobject fill(Pointer<Py_ssize_t > fill) {
		this.io.setPointerField(this, 2, fill);
		return this;
	}
	/**
	 * # Active<br>
	 ...
	 */
	@Field(3) 
	public Pointer<Py_ssize_t > used() {
	 ...
	 */
	@Field(3) 
	public _setobject used(Pointer<Py_ssize_t > used) {
		this.io.setPointerField(this, 3, used);
		return this;
	}
	/**
	 ...
	 */
	@Field(4) 
	public Pointer<Py_ssize_t > mask() {
	 ...
	 */
	@Field(4) 
	public _setobject mask(Pointer<Py_ssize_t > mask) {
		this.io.setPointerField(this, 4, mask);
		return this;
	}
	/**
